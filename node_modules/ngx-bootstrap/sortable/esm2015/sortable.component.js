...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r796); const ctx_r795 = ɵngcc0.ɵɵnextContext(); return ctx_r795.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r796); const ctx_r797 = ɵngcc0.ɵɵnextContext(); return ctx_r797.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r791 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r791.placeholderClass)("ngStyle", ctx_r791.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r791.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r802); const item_r798 = ctx.$implicit; const i_r799 = ctx.index; const ctx_r801 = ɵngcc0.ɵɵnextContext(); return ctx_r801.onItemDragstart($event, item_r798, i_r799); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r802); const ctx_r803 = ɵngcc0.ɵɵnextContext(); return ctx_r803.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r802); const i_r799 = ctx.index; const ctx_r804 = ɵngcc0.ɵɵnextContext(); return ctx_r804.onItemDragover($event, i_r799); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r802); const ctx_r805 = ɵngcc0.ɵɵnextContext(); return ctx_r805.cancelEvent($event); });
    ɵngcc0.ɵɵtemplate(1, SortableComponent_div_2_ng_template_1_Template, 0, 0, "ng-template", 6);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r798 = ctx.$implicit;
    const i_r799 = ctx.index;
    const ctx_r792 = ɵngcc0.ɵɵnextContext();
    const _r793 = ɵngcc0.ɵɵreference(4);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r792.itemClass, i_r799 === ctx_r792.activeItem ? ctx_r792.itemActiveClass : ""))("ngStyle", ctx_r792.getItemStyle(i_r799 === ctx_r792.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r799 === ctx_r792.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r792.itemTemplate || _r793)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r798, i_r799));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r806 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r806.value);
} }
