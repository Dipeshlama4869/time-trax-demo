...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    const _r1034 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 4);
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1034); const ctx_r1033 = ɵngcc0.ɵɵnextContext(); return ctx_r1033.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1034); const ctx_r1035 = ɵngcc0.ɵɵnextContext(); return ctx_r1035.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1029 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r1029.placeholderClass)("ngStyle", ctx_r1029.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r1029.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1040); const item_r1036 = ctx.$implicit; const i_r1037 = ctx.index; const ctx_r1039 = ɵngcc0.ɵɵnextContext(); return ctx_r1039.onItemDragstart($event, item_r1036, i_r1037); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1040); const ctx_r1041 = ɵngcc0.ɵɵnextContext(); return ctx_r1041.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1040); const i_r1037 = ctx.index; const ctx_r1042 = ɵngcc0.ɵɵnextContext(); return ctx_r1042.onItemDragover($event, i_r1037); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1040); const ctx_r1043 = ɵngcc0.ɵɵnextContext(); return ctx_r1043.cancelEvent($event); });
    ɵngcc0.ɵɵtemplate(1, SortableComponent_div_2_ng_template_1_Template, 0, 0, "ng-template", 6);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r1036 = ctx.$implicit;
    const i_r1037 = ctx.index;
    const ctx_r1030 = ɵngcc0.ɵɵnextContext();
    const _r1031 = ɵngcc0.ɵɵreference(4);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r1030.itemClass, i_r1037 === ctx_r1030.activeItem ? ctx_r1030.itemActiveClass : ""))("ngStyle", ctx_r1030.getItemStyle(i_r1037 === ctx_r1030.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r1037 === ctx_r1030.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r1030.itemTemplate || _r1031)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r1036, i_r1037));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r1044 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r1044.value);
} }
