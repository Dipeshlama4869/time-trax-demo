...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r124); const ctx_r123 = ɵngcc0.ɵɵnextContext(); return ctx_r123.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r124); const ctx_r125 = ɵngcc0.ɵɵnextContext(); return ctx_r125.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r119 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r119.placeholderClass)("ngStyle", ctx_r119.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r119.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r130); const item_r126 = ctx.$implicit; const i_r127 = ctx.index; const ctx_r129 = ɵngcc0.ɵɵnextContext(); return ctx_r129.onItemDragstart($event, item_r126, i_r127); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r130); const ctx_r131 = ɵngcc0.ɵɵnextContext(); return ctx_r131.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r130); const i_r127 = ctx.index; const ctx_r132 = ɵngcc0.ɵɵnextContext(); return ctx_r132.onItemDragover($event, i_r127); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r130); const ctx_r133 = ɵngcc0.ɵɵnextContext(); return ctx_r133.cancelEvent($event); });
    ...
    const _r121 = ɵngcc0.ɵɵreference(4);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r120.itemClass, i_r127 === ctx_r120.activeItem ? ctx_r120.itemActiveClass : ""))("ngStyle", ctx_r120.getItemStyle(i_r127 === ctx_r120.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r127 === ctx_r120.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r120.itemTemplate || _r121)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r126, i_r127));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r134 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r134.value);
} }
