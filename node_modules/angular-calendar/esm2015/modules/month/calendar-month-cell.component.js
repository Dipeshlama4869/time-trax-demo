...
function CalendarMonthCellComponent_ng_template_0_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const day_r311 = ɵngcc0.ɵɵnextContext().day;
    ɵngcc0.ɵɵadvance(1);
...
function CalendarMonthCellComponent_ng_template_0_div_7_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mouseenter", function CalendarMonthCellComponent_ng_template_0_div_7_div_1_Template_div_mouseenter_0_listener() { ɵngcc0.ɵɵrestoreView(_r330); const event_r327 = ctx.$implicit; const highlightDay_r315 = ɵngcc0.ɵɵnextContext(2).highlightDay; return highlightDay_r315.emit({ event: event_r327 }); })("mouseleave", function CalendarMonthCellComponent_ng_template_0_div_7_div_1_Template_div_mouseleave_0_listener() { ɵngcc0.ɵɵrestoreView(_r330); const event_r327 = ctx.$implicit; const unhighlightDay_r316 = ɵngcc0.ɵɵnextContext(2).unhighlightDay; return unhighlightDay_r316.emit({ event: event_r327 }); })("mwlClick", function CalendarMonthCellComponent_ng_template_0_div_7_div_1_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r330); const event_r327 = ctx.$implicit; const eventClicked_r317 = ɵngcc0.ɵɵnextContext(2).eventClicked; return eventClicked_r317.emit({ event: event_r327, sourceEvent: $event }); });
    ɵngcc0.ɵɵpipe(1, "calendarEventTitle");
    ɵngcc0.ɵɵpipe(2, "calendarA11y");
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const event_r327 = ctx.$implicit;
    const ctx_r335 = ɵngcc0.ɵɵnextContext(2);
    const tooltipPlacement_r314 = ctx_r335.tooltipPlacement;
    const tooltipTemplate_r318 = ctx_r335.tooltipTemplate;
    const tooltipAppendToBody_r319 = ctx_r335.tooltipAppendToBody;
    const tooltipDelay_r320 = ctx_r335.tooltipDelay;
    const day_r311 = ctx_r335.day;
    const validateDrag_r322 = ctx_r335.validateDrag;
...
function CalendarMonthCellComponent_ng_template_0_div_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const day_r311 = ctx_r336.day;
    const trackByEventId_r321 = ctx_r336.trackByEventId;
    ɵngcc0.ɵɵadvance(1);
...
function CalendarMonthCellComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const day_r311 = ctx.day;
    const locale_r313 = ctx.locale;
...
CalendarMonthCellComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarMonthCellComponent, selectors: [["mwl-calendar-month-cell"]], hostAttrs: [1, "cal-cell", "cal-day-cell"], hostVars: 18, hostBindings: function CalendarMonthCellComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ...
        const _r308 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
