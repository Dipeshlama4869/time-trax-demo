...
function CalendarMonthViewHeaderComponent_ng_template_0_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function CalendarMonthViewHeaderComponent_ng_template_0_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r306); const day_r304 = ctx.$implicit; const ctx_r305 = ɵngcc0.ɵɵnextContext(2); return ctx_r305.columnHeaderClicked.emit({ isoDayNumber: day_r304.day, sourceEvent: $event }); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵpipe(2, "calendarDate");
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const day_r304 = ctx.$implicit;
    const locale_r301 = ɵngcc0.ɵɵnextContext().locale;
...
function CalendarMonthViewHeaderComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const days_r300 = ctx.days;
    const trackByWeekDayHeaderDate_r302 = ctx.trackByWeekDayHeaderDate;
    ɵngcc0.ɵɵadvance(1);
