...
function CalendarWeekViewEventComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r451); const eventClicked_r443 = ctx.eventClicked; return eventClicked_r443.emit({ sourceEvent: $event }); })("mwlKeydownEnter", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlKeydownEnter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r451); const eventClicked_r443 = ctx.eventClicked; return eventClicked_r443.emit({ sourceEvent: $event }); });
    ...
    const weekEvent_r441 = ctx.weekEvent;
    const tooltipPlacement_r442 = ctx.tooltipPlacement;
    const tooltipTemplate_r444 = ctx.tooltipTemplate;
    const tooltipAppendToBody_r445 = ctx.tooltipAppendToBody;
    const tooltipDisabled_r446 = ctx.tooltipDisabled;
    const tooltipDelay_r447 = ctx.tooltipDelay;
    const daysInWeek_r449 = ctx.daysInWeek;
    const ctx_r439 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(20, _c0, weekEvent_r441.event.color == null ? null : weekEvent_r441.event.color.secondary, weekEvent_r441.event.color == null ? null : weekEvent_r441.event.color.primary))("mwlCalendarTooltip", !tooltipDisabled_r446 ? ɵngcc0.ɵɵpipeBind3(1, 13, weekEvent_r441.event.title, daysInWeek_r449 === 1 ? "dayTooltip" : "weekTooltip", weekEvent_r441.tempEvent || weekEvent_r441.event) : "")("tooltipPlacement", tooltipPlacement_r442)("tooltipEvent", weekEvent_r441.tempEvent || weekEvent_r441.event)("tooltipTemplate", tooltipTemplate_r444)("tooltipAppendToBody", tooltipAppendToBody_r445)("tooltipDelay", tooltipDelay_r447);
    ɵngcc0.ɵɵattribute("aria-label", ɵngcc0.ɵɵpipeBind2(2, 17, ɵngcc0.ɵɵpureFunction2(23, _c1, weekEvent_r441.tempEvent || weekEvent_r441.event, ctx_r439.locale), "eventDescription"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("event", weekEvent_r441.tempEvent || weekEvent_r441.event)("customTemplate", ctx_r439.eventActionsTemplate);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("event", weekEvent_r441.tempEvent || weekEvent_r441.event)("customTemplate", ctx_r439.eventTitleTemplate)("view", daysInWeek_r449 === 1 ? "day" : "week");
} }
...
CalendarWeekViewEventComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarWeekViewEventComponent, selectors: [["mwl-calendar-week-view-event"]], inputs: { locale: "locale", weekEvent: "weekEvent", tooltipPlacement: "tooltipPlacement", tooltipAppendToBody: "tooltipAppendToBody", tooltipDisabled: "tooltipDisabled", tooltipDelay: "tooltipDelay", customTemplate: "customTemplate", eventTitleTemplate: "eventTitleTemplate", eventActionsTemplate: "eventActionsTemplate", tooltipTemplate: "tooltipTemplate", column: "column", daysInWeek: "daysInWeek" }, outputs: { eventClicked: "eventClicked" }, decls: 3, vars: 12, consts: [["defaultTemplate", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["tabindex", "0", "role", "application", 1, "cal-event", 3, "ngStyle", "mwlCalendarTooltip", "tooltipPlacement", "tooltipEvent", "tooltipTemplate", "tooltipAppendToBody", "tooltipDelay", "mwlClick", "mwlKeydownEnter"], [3, "event", "customTemplate"], [3, "event", "customTemplate", "view"]], template: function CalendarWeekViewEventComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        const _r438 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.customTemplate || _r438)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunctionV(2, _c2, [ctx.weekEvent, ctx.tooltipPlacement, ctx.eventClicked, ctx.tooltipTemplate, ctx.tooltipAppendToBody, ctx.tooltipDisabled, ctx.tooltipDelay, ctx.column, ctx.daysInWeek]));
