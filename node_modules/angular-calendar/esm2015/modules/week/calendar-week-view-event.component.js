...
function CalendarWeekViewEventComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    const _r467 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 2);
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r467); const eventClicked_r459 = ctx.eventClicked; return eventClicked_r459.emit({ sourceEvent: $event }); })("mwlKeydownEnter", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlKeydownEnter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r467); const eventClicked_r459 = ctx.eventClicked; return eventClicked_r459.emit({ sourceEvent: $event }); });
    ...
    const weekEvent_r457 = ctx.weekEvent;
    const tooltipPlacement_r458 = ctx.tooltipPlacement;
    const tooltipTemplate_r460 = ctx.tooltipTemplate;
    const tooltipAppendToBody_r461 = ctx.tooltipAppendToBody;
    const tooltipDisabled_r462 = ctx.tooltipDisabled;
    const tooltipDelay_r463 = ctx.tooltipDelay;
    const daysInWeek_r465 = ctx.daysInWeek;
    const ctx_r455 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(20, _c0, weekEvent_r457.event.color == null ? null : weekEvent_r457.event.color.secondary, weekEvent_r457.event.color == null ? null : weekEvent_r457.event.color.primary))("mwlCalendarTooltip", !tooltipDisabled_r462 ? ɵngcc0.ɵɵpipeBind3(1, 13, weekEvent_r457.event.title, daysInWeek_r465 === 1 ? "dayTooltip" : "weekTooltip", weekEvent_r457.tempEvent || weekEvent_r457.event) : "")("tooltipPlacement", tooltipPlacement_r458)("tooltipEvent", weekEvent_r457.tempEvent || weekEvent_r457.event)("tooltipTemplate", tooltipTemplate_r460)("tooltipAppendToBody", tooltipAppendToBody_r461)("tooltipDelay", tooltipDelay_r463);
    ɵngcc0.ɵɵattribute("aria-label", ɵngcc0.ɵɵpipeBind2(2, 17, ɵngcc0.ɵɵpureFunction2(23, _c1, weekEvent_r457.tempEvent || weekEvent_r457.event, ctx_r455.locale), "eventDescription"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("event", weekEvent_r457.tempEvent || weekEvent_r457.event)("customTemplate", ctx_r455.eventActionsTemplate);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("event", weekEvent_r457.tempEvent || weekEvent_r457.event)("customTemplate", ctx_r455.eventTitleTemplate)("view", daysInWeek_r465 === 1 ? "day" : "week");
} }
...
CalendarWeekViewEventComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarWeekViewEventComponent, selectors: [["mwl-calendar-week-view-event"]], inputs: { locale: "locale", weekEvent: "weekEvent", tooltipPlacement: "tooltipPlacement", tooltipAppendToBody: "tooltipAppendToBody", tooltipDisabled: "tooltipDisabled", tooltipDelay: "tooltipDelay", customTemplate: "customTemplate", eventTitleTemplate: "eventTitleTemplate", eventActionsTemplate: "eventActionsTemplate", tooltipTemplate: "tooltipTemplate", column: "column", daysInWeek: "daysInWeek" }, outputs: { eventClicked: "eventClicked" }, decls: 3, vars: 12, consts: [["defaultTemplate", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["tabindex", "0", "role", "application", 1, "cal-event", 3, "ngStyle", "mwlCalendarTooltip", "tooltipPlacement", "tooltipEvent", "tooltipTemplate", "tooltipAppendToBody", "tooltipDelay", "mwlClick", "mwlKeydownEnter"], [3, "event", "customTemplate"], [3, "event", "customTemplate", "view"]], template: function CalendarWeekViewEventComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        const _r454 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.customTemplate || _r454)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunctionV(2, _c2, [ctx.weekEvent, ctx.tooltipPlacement, ctx.eventClicked, ctx.tooltipTemplate, ctx.tooltipAppendToBody, ctx.tooltipDisabled, ctx.tooltipDelay, ctx.column, ctx.daysInWeek]));
