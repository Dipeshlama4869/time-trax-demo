...
function CalendarWeekViewEventComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r440); const eventClicked_r432 = ctx.eventClicked; return eventClicked_r432.emit({ sourceEvent: $event }); })("mwlKeydownEnter", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlKeydownEnter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r440); const eventClicked_r432 = ctx.eventClicked; return eventClicked_r432.emit({ sourceEvent: $event }); });
    ...
    const weekEvent_r430 = ctx.weekEvent;
    const tooltipPlacement_r431 = ctx.tooltipPlacement;
    const tooltipTemplate_r433 = ctx.tooltipTemplate;
    const tooltipAppendToBody_r434 = ctx.tooltipAppendToBody;
    const tooltipDisabled_r435 = ctx.tooltipDisabled;
    const tooltipDelay_r436 = ctx.tooltipDelay;
    const daysInWeek_r438 = ctx.daysInWeek;
    const ctx_r428 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(20, _c0, weekEvent_r430.event.color == null ? null : weekEvent_r430.event.color.secondary, weekEvent_r430.event.color == null ? null : weekEvent_r430.event.color.primary))("mwlCalendarTooltip", !tooltipDisabled_r435 ? ɵngcc0.ɵɵpipeBind3(1, 13, weekEvent_r430.event.title, daysInWeek_r438 === 1 ? "dayTooltip" : "weekTooltip", weekEvent_r430.tempEvent || weekEvent_r430.event) : "")("tooltipPlacement", tooltipPlacement_r431)("tooltipEvent", weekEvent_r430.tempEvent || weekEvent_r430.event)("tooltipTemplate", tooltipTemplate_r433)("tooltipAppendToBody", tooltipAppendToBody_r434)("tooltipDelay", tooltipDelay_r436);
    ɵngcc0.ɵɵattribute("aria-label", ɵngcc0.ɵɵpipeBind2(2, 17, ɵngcc0.ɵɵpureFunction2(23, _c1, weekEvent_r430.tempEvent || weekEvent_r430.event, ctx_r428.locale), "eventDescription"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("event", weekEvent_r430.tempEvent || weekEvent_r430.event)("customTemplate", ctx_r428.eventActionsTemplate);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("event", weekEvent_r430.tempEvent || weekEvent_r430.event)("customTemplate", ctx_r428.eventTitleTemplate)("view", daysInWeek_r438 === 1 ? "day" : "week");
} }
...
CalendarWeekViewEventComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarWeekViewEventComponent, selectors: [["mwl-calendar-week-view-event"]], inputs: { locale: "locale", weekEvent: "weekEvent", tooltipPlacement: "tooltipPlacement", tooltipAppendToBody: "tooltipAppendToBody", tooltipDisabled: "tooltipDisabled", tooltipDelay: "tooltipDelay", customTemplate: "customTemplate", eventTitleTemplate: "eventTitleTemplate", eventActionsTemplate: "eventActionsTemplate", tooltipTemplate: "tooltipTemplate", column: "column", daysInWeek: "daysInWeek" }, outputs: { eventClicked: "eventClicked" }, decls: 3, vars: 12, consts: [["defaultTemplate", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["tabindex", "0", "role", "application", 1, "cal-event", 3, "ngStyle", "mwlCalendarTooltip", "tooltipPlacement", "tooltipEvent", "tooltipTemplate", "tooltipAppendToBody", "tooltipDelay", "mwlClick", "mwlKeydownEnter"], [3, "event", "customTemplate"], [3, "event", "customTemplate", "view"]], template: function CalendarWeekViewEventComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        const _r427 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.customTemplate || _r427)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunctionV(2, _c2, [ctx.weekEvent, ctx.tooltipPlacement, ctx.eventClicked, ctx.tooltipTemplate, ctx.tooltipAppendToBody, ctx.tooltipDisabled, ctx.tooltipDelay, ctx.column, ctx.daysInWeek]));
