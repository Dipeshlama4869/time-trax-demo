...
function CalendarWeekViewEventComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r451); var eventClicked_r443 = ctx.eventClicked; return eventClicked_r443.emit({ sourceEvent: $event }); })("mwlKeydownEnter", function CalendarWeekViewEventComponent_ng_template_0_Template_div_mwlKeydownEnter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r451); var eventClicked_r443 = ctx.eventClicked; return eventClicked_r443.emit({ sourceEvent: $event }); });
    ...
    var weekEvent_r441 = ctx.weekEvent;
    var tooltipPlacement_r442 = ctx.tooltipPlacement;
    var tooltipTemplate_r444 = ctx.tooltipTemplate;
    var tooltipAppendToBody_r445 = ctx.tooltipAppendToBody;
    var tooltipDisabled_r446 = ctx.tooltipDisabled;
    var tooltipDelay_r447 = ctx.tooltipDelay;
    var daysInWeek_r449 = ctx.daysInWeek;
